...
package thesis.rttsd_thesis.classifier;
...
/** A thesis.rttsd_thesis.classifier specialized to label images using TensorFlow Lite. */
public abstract class Classifier {
  ...
  /**
   * Creates a thesis.rttsd_thesis.classifier with the provided configuration.
   *
   * @param activity The current Activity.
   * @param model The model to use for classification.
   * @param device The device to use for classification.
   * @param numThreads The number of threads to use for classification.
   * @return A thesis.rttsd_thesis.classifier with the desired configuration.
   */
  public static ClassifierYolov5 create(Activity activity, Model model, Device device, int numThreads)
      throws IOException {
    if (model == Model.YOLO_V5) {
      return new ClassifierYolov5(activity, device, numThreads);
    } else {
